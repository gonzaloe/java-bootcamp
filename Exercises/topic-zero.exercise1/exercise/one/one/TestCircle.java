...
public class TestCircle {        
	   ...
	   public static void main(String[] args) {
	      ...
	      System.out.println("The circle has radius of " 
	         + c2.getRadius() + " and area of " + c2.getArea() + " and color " + c2.getColor());
	      
	      Circle c3 = new Circle();
	      c3.setRadius(5.0);
	      c3.setColor("blue");
	      System.out.println(c3.toString()); // explicit toString() call
	      System.out.println(c2); // implicit toString() call
